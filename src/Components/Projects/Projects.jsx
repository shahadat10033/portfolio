  ...
  return (
    <div id="projects" className=" " style={{ minHeight: "100vh" }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-3/4 lg:w-1/2 mx-auto gap-10 md:gap-20">
        ...
        <div
          className="card w-92 hover:scale-110 duration-500 hover:shadow-blue-400 lg:w-80  bg-[#3A83F2] shadow-2xl shadow-black border border-white"
          onMouseLeave={() => setIsArrow1Clicked(false)}
        >
          <figure style={{ height: "300px", overflow: "auto" }} className="">
        ...
        <div
          className="card hover:scale-110 duration-500 hover:shadow-blue-400 w-92 lg:w-80  bg-[#3A83F2] shadow-2xl shadow-black border border-white"
